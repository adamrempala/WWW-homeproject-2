...
const sameQuizTwoTimes = (driver: ThenableWebDriver) => {
    return it ('We cannot get into the quiz second time', async function() {
        this.timeout(10000);
...
const logoutAfterChangingPassword = (driver: ThenableWebDriver) => {
    return it ('After password change another sessions should log out', async function() {
        await driver.get("http://localhost:3000");
        await driver.findElement(By.name("username")).sendKeys("user1");
        await driver.findElement(By.name("password")).sendKeys("user1");
        await driver.findElement(By.id("submit")).click();
...
const appBehavior = (driver: ThenableWebDriver) => {
    return it ('Returned JSON files should have proper structure', async function(){
        await driver.get("http://localhost:3000")
